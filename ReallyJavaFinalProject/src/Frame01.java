...
public class Frame01 extends JFrame implements ActionListener{
	...
	public Frame01() {
				...
				//Frame Adding zone
					...
					gl_RegisterID.setHorizontalGroup(
						gl_RegisterID.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_RegisterID.createSequentialGroup()
								.addContainerGap()
								.addGroup(gl_RegisterID.createParallelGroup(Alignment.TRAILING, false)
									.addComponent(passwordField, Alignment.LEADING)
									.addComponent(textField, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 483, Short.MAX_VALUE)
									.addComponent(RegisterTopic2, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 151, GroupLayout.PREFERRED_SIZE)
									.addComponent(lblNewLabel, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 283, GroupLayout.PREFERRED_SIZE))
					...
					btnRegister.setFont(new Font("MV Boli", Font.PLAIN, 30));
					...
					gl_RegisterPass.setHorizontalGroup(
						gl_RegisterPass.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_RegisterPass.createSequentialGroup()
								.addGroup(gl_RegisterPass.createParallelGroup(Alignment.LEADING)
									.addGroup(gl_RegisterPass.createSequentialGroup()
										.addGap(100)
										.addComponent(btnNewButton, GroupLayout.PREFERRED_SIZE, 188, GroupLayout.PREFERRED_SIZE)
										.addGap(18)
										.addComponent(btnCancel, GroupLayout.PREFERRED_SIZE, 188, GroupLayout.PREFERRED_SIZE))
									.addGroup(gl_RegisterPass.createSequentialGroup()
										.addContainerGap()
